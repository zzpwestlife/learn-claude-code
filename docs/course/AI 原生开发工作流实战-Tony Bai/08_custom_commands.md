...
![](./assets/images/08_image.png)

### 环境与配置类: 你的 AI "控制面板"

这类指令让你能够实时地查看和修改 Claude Code 的运行配置, 将其调校到最称手的状态.

![](./assets/images/08_image_2.png)

![](./assets/images/08_image_3.png)

![](./assets/images/08_image_4.png)

![](./assets/images/08_image_5.png)

### 项目与协作类: 将 AI 融入工程实践

这类指令与具体的软件工程任务紧密相关.

![](./assets/images/08_image_6.png)

### 元信息与帮助类: 你的实时 "说明书"

这类指令帮助你随时了解工具的状态和获取帮助.

![](./assets/images/08_image_7.png)

![](./assets/images/08_image_8.png)

![](./assets/images/08_image_9.png)

![](./assets/images/08_image_10.png)

![](./assets/images/08_image_11.png)

![](./assets/images/08_image_12.png)
