...
![](../docs/assets/images/09_image.png)
...
![](../docs/assets/images/09_image_2.png)

![](../docs/assets/images/09_image_3.png)

![](../docs/assets/images/09_image_4.png)
...
![](../docs/assets/images/09_image_5.png)
...
![](../docs/assets/images/09_image_6.png)

![](../docs/assets/images/09_image_7.png)
...
![](../docs/assets/images/09_image_8.png)
...
![](../docs/assets/images/09_image_9.png)
...
* 默认读权限: 相对开放. 箱内的进程默认拥有对 几乎整个计算机 的 只读 访问权限. 这是一种非常务实的设计, 它允许 AI 在需要时, 能够像人类开发者一样, 去读取系统库、全局配置文件或其他项目的文件来获取解决问题所需的上下文.
