...
![](../assets/images/12_image_6.png)

回车后, 查看 github mcp 服务器的详细信息: 

![](../assets/images/12_image_7.png)

选择 View tools, 我们将看到 github MCP 服务器注册的能力列表: 

![](../assets/images/12_image_8.png)
...
![](../assets/images/12_image_10.png)

通过 github 页面, 我们也能查看到新创建的 issue: 

![](../assets/images/12_image_11.png)

接下来, 我们让 Claude Code 为该 issue 添加一条评论: 

![](../assets/images/12_image_12.png)

![](../assets/images/12_image_13.png)

然后再关闭该 issue: 

![](../assets/images/12_image_14.png)

![](../assets/images/12_image_15.png)
