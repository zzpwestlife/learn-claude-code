...
This context is relevant when working in `src/`.

## Directory Responsibilities
-   **CLI**: Command-line interface tools (`src/cli/`).
...
| File | Type | Role |
| :--- | :--- | :--- |
| `cli/tui.py` | Python | **TUI**: Interactive menu for project commands. |
...
- **Main Guard**: Always use `if __name__ == "__main__":` block for executable scripts.
