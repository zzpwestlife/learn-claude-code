...
`/Applications/ServBay/script/alias/node /Users/admin/claude-code-notification/src/index.js --type success --title 'go-code-security-reviewer Task' --message 'Task finished.'`
